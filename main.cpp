...
//======================================================
//converts commands to lowercase
...
{
	HashTable myHashTable(1171891);//(2124867); //for en-de.txt
	//HashTable myHashTable(43973);//for en-es.txt
	//HashTable myHashTable(132403);//for en-fr.txr
	...
	while(true)
	{
		...
		string lowerCommand = toLower(command); //turns command to lowercase

			if(lowerCommand == "find")   		  myHashTable.find(argument1);
		else if(lowerCommand == "import")		  myHashTable.import(argument1);
		else if(lowerCommand == "add")		      myHashTable.insert(argument1,argument2,argument3); //word,meaning,language
		else if(lowerCommand == "delWord")         myHashTable.delWord(argument1);
		else if(lowerCommand == "delTranslation")  myHashTable.delTranslation(argument1,argument2);
		else if(lowerCommand == "delMeaning")      myHashTable.delMeaning(argument1,argument2,argument3);
		else if(lowerCommand == "export")          myHashTable.exportData(argument1,argument2);
		else if(lowerCommand == "help")	  	      help();
		else if(lowerCommand == "exit")	  	      break;
